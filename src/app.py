...
def load_all_prices():
    ...
    config_path = os.path.join(os.path.dirname(__file__), "..", "config_precios.json")
    ...
    with col2:
        if st.button("PARAR"):
            ...
            if taxi is None or not st.session_state.is_runnig:
            ...
            if taxi is None or not st.session_state.is_running:
                ...
                try:
                    ...
                    st.json(
                            ...
                            {
                             "Tiempo parado (s):" :round(summary['stoppep_time'], 1),
                             "Tiempo en marcha (s):" :round(summary['moving_time'], 1),
                             "Total (€):" :round(summary ['total-fare'], 2),
